...
const Header = async () => {
  return (
    <header className="bg-gradient-to-b z-50  from-black via-black  border-b-[0.5px] border-white/10 to-transparent fixed backdrop-blur-sm max-w-9xl mx-auto w-full flex flex-row py-2 px-5 justify-between">
